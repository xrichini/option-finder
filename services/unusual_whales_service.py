...
class UnusualWhalesService:
    ...
    def __init__(self, enable_historical: bool = True):
        # Historical manager removed - using hybrid_data_service instead
    ...
    def calculate_large_block_score(
        self, volume: int, whale_threshold: int = 5000
    ) -> float:
    ...
    def calculate_whale_score_v3(
        ...
        base_score = self.calculate_whale_score(volume_1d, open_interest, delta, iv)
        ...
        if self.historical_manager:
            try:
                ...
                volume_anomaly, vol_stats = (
                    self.historical_manager.calculate_volume_anomaly(
                ...
                historical_stats = {"volume_stats": vol_stats, "oi_stats": oi_stats}
    ...
    def analyze_opportunity(self, opp: OptionsOpportunity) -> Dict[str, Any]:
        ...
        try:
            ...
            analysis = {
                ...
                "volume_anomaly_level": self._get_anomaly_level(
                    scoring_details.get("volume_anomaly", 0)
                ),
                "oi_anomaly_level": self._get_anomaly_level(
                    scoring_details.get("oi_anomaly", 0)
                ),
                ...
                "hot_volume": scoring_details.get("volume_anomaly", 0)
                >= 70,  # 300%+ above average
                "anomaly_badge": (
                    "🚨" if scoring_details.get("volume_anomaly", 0) >= 85 else None
                ),
            }
            ...
            for opp in opportunities:
                ...
                result_obj = type(
                    ...
                    (),
                    {
                        ...
                        "vol_oi_ratio": self.get_vol_oi_ratio(
                            opp.volume, opp.open_interest
                        ),
                    },
                )
