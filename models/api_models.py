...
class ScreeningRequest(BaseModel):
    ...
    min_whale_score: float = Field(default=30.0, ge=0, le=100, description="Score whale minimum")
...
def create_error_response(error: str, code: str = None, details: Dict = None) -> ErrorResponse:
