...
def main():
    ...
    if not st.secrets.get("TRADIER_API_KEY") and not st.session_state.get("api_configured"):
        st.error("🔑 Clé API Tradier requise !")
        st.markdown("""
        ### Configuration requise

        1. **Clé API Tradier** - Obtenez votre clé sur [tradier.com](https://tradier.com)
